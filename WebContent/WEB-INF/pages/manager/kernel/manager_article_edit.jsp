...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="${ctx}/resource/mobile/js/font-awesome.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="${ctx}/resource/mobile/js/ionicons.min.css">
  <!-- Theme style -->
...
<!-- CK Editor -->
<script src="${ctx}/resource/mobile/js/ckeditor.js"></script>
<!-- Bootstrap WYSIHTML5 -->
